    ...
    <div className="relative min-h-screen flex flex-col max-auto text-center items-center justify-center overflow-hidden">
      ...
      <div className="text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-3"> 
          <motion.a 
            href="/projects" 
            className="px-6 py-2 bg-gray-300 rounded-lg text-black transition hover:scale-110 duration:200 shadow-md"
          ...
          <motion.a 
            href="" 
            className="px-6 py-2 bg-gray-700 rounded-lg text-white transition hover:scale-110 duration:200 shadow-md"
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
